...
pub use utxo_manager::{UTXOManager, UTXO, AddressBalance, CoinSelectionAlgorithm, UTXOStats};
pub use transaction_processor::{TransactionProcessor, TransactionResult, TransactionStatus, FeeCalculator, ProcessingStats};
